export default {
  ...
  // ===============
  'app.menu.basic.userCenter.voteList': '个人投票管理',
  'app.menu.basic.userCenter.analyseList': '个人统计管理',
  'app.menu.basic.createVote': '个人创建投票',
  'app.menu.basic.userCenter.profile': '个人资料',

   // ===============
  'app.menu.admin.userList': '用户管理',
  'app.menu.admin.voteList': '投票管理',
  'app.menu.admin.infoList': '公告管理',
  'app.menu.admin.analyseList': '统计管理',
};
